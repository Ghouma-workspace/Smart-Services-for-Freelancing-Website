...
import { SignupRequestPayload } from '../pages/register/SignupRequestPayload';
import { LoginRequestPayload } from '../pages/login/login-request.payload';
import { LoginResponse } from '../pages/login/login-response.payload';
...
export class AuthService {
  ...
  getAllFreelancers(): Observable<Freelancer[]>{
    return this.httpClient.get<Freelancer[]>("http://localhost:8080/auth/freelancers");
  }
}
